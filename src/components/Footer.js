          ...
          <div className="container-fluid">
            ...
            <div id="signature" className="row bg-dark py-2">
              <div className="col text-center pt-2">
                <h6 className="text-white">Copyright © {currYear} | All rights reserved | Delivered by <a href="https://github.com/kibbyd" target="_blank">The Milkman</a><img src={require("../assets/images/milkBottle.png")} height="20px" alt="milk bottle" className="mb-1"/>
                </h6>
              </div>
            </div>		
          </div>		
